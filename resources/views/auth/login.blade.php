@if(request()->has('aviso') && request()->aviso === 'login_required')
    <div class="alert alert-warning" style="margin-bottom: 20px;">
        ⚠️ Faça login antes de realizar um descarte.
    </div>
@endif
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control" name="password" placeholder="Favor inserir sua senha"  tabindex="2" value="{{ old('password') }}" required>
                    <div class="invalid-feedback">

...
document.getElementById('btnScroll').addEventListener('click', () => {
    const deOnde = document.getElementById('Descart');
    const paraOnde = document.getElementById('Descart2');

    if (deOnde && paraOnde) {
        // Pega a posição do elemento de destino
        const posicaoDestino = paraOnde.getBoundingClientRect().top + window.scrollY;
